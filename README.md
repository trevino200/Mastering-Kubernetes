...
Open three different terminals to login to the cluster nodes. One will be the master and the 2 others will be the worker nodes where the pods with containers will be managed.
